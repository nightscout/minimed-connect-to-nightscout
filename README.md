...
>
> nightscout-connect provides the same Medtronic CareLink functionality with:
> - Modern dependency stack (Node 18/20/22+ support)
> - State machine architecture for robust sync
> - Multiple data sources (Dexcom Share, LibreLinkUp, Medtronic CareLink, and more)
>
> See the [Migration Guide](https://github.com/nightscout/nightscout-connect#medtronic-carelink) for environment variable mapping.
